"""GitBot CLI — AI-powered git history reviewer."""
...
app = typer.Typer(
    name="gitbot",
    help="🤖 GitBot — AI-powered git history reviewer",
...
def _generate_markdown_report(
    ...
    lines.extend([
        ...
        f"---",
        f"",
        f"*Report generated by GitBot v0.1.0 — powered by Claude*",
    ])
...
def review(
    ...
    console.print(f"[green]✓[/green] Grouped into [bold]{len(groups)}[/bold] sections")
    ...
    console.print(Rule())
    console.print(
        "[dim]GitBot v0.1.0 — powered by Claude · "
